...
public class GridHorarioInternalFrame extends JInternalFrame {
	...
	public GridHorarioInternalFrame(Atividade[][] semana, Vector<Curso> cursos, String title, boolean a, boolean b, boolean c, boolean d) {
		super(title, a, b, c, d);
		this.cursos = cursos;
